package cn.caijiajia.ratelimiter.server.util;
...
public class EncryptUtils {
    ...
    public static String encrypt(String origin, String key) {
        try {
            ...
            return new BASE64Encoder().encode(cipher.doFinal(origin.getBytes()));
        } catch (Exception e) {
        }
        return null;
    }
    ...
    public static String decrypt(String source, String key) {
        try {
            ...
            return new String(cipher.doFinal(new BASE64Decoder().decodeBuffer(source)));
        } catch (Exception e) {
        }
        return null;
    }
