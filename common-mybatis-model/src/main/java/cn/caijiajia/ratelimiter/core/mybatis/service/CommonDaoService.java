package cn.caijiajia.ratelimiter.core.mybatis.service;
...
public interface CommonDaoService {
     ...
     * @return
     */
    <T extends BaseEntity> int deletePhysically(T model);
    /**
     * 逻辑删除
     *
     * @param modelClass
     ...
     * @return
     */
    <T extends BaseEntity> int deletePhysically(Class<T> modelClass,
                                      Object key);
    /**
     * 根据主键获取
     *
