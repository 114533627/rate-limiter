package cn.caijiajia.ratelimiter.core.mybatis.service.impl;
...
public class CommonDaoServiceImpl implements CommonDaoService {
    ...
    public <T extends BaseEntity> int insertList(List<T> models) {
        ...
        int i = CommonDaoHelper.getMapper(models.get(0)).insertList(models);
        return i;
    }
    ...
    @Override
    public <T extends BaseEntity> int deletePhysically(T model) {
        return CommonDaoHelper.getMapper(model).delete(model);
    }
    ...
    @Override
    public <T extends BaseEntity> int deletePhysically(Class<T> modelClass, Object key) {
        return deletePhysically(get(modelClass, key));
    }
